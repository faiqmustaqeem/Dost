...
public class ReligiousTourismActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ReligiousTourismAdapter(getReligiousTourismItems() , getApplicationContext(),activity);
    ...
    List<ReligiousTourismModel> getReligiousTourismItems()
    {
        ...
        list.add(new ReligiousTourismModel("Religious Tourism","03128676054",""));
        list.add(new ReligiousTourismModel("Religious Tourism","03128676054",""));
        list.add(new ReligiousTourismModel("Religious Tourism","03128676054",""));
        list.add(new ReligiousTourismModel("Religious Tourism","03128676054",""));
        list.add(new ReligiousTourismModel("Religious Tourism","03128676054",""));
